...
export const config = {
  ...
  agentcashAutoRefillThresholdUsd: Number.parseFloat(process.env.AGENTCASH_AUTO_REFILL_THRESHOLD_USD || "0"),
  agentcashAutoRefillAmountUsd: Number.parseFloat(process.env.AGENTCASH_AUTO_REFILL_AMOUNT_USD || "0"),
  agentcashAutoRefillDailyCapUsd: Number.parseFloat(process.env.AGENTCASH_AUTO_REFILL_DAILY_CAP_USD || "0"),
