...
export const config = {
  ...
  dailyAutonomyEnabled: process.env.TRUST402_DAILY_AUTONOMY_ENABLED === "true",
  dailyAutonomyMode: process.env.TRUST402_DAILY_AUTONOMY_MODE || "dry-run",
  dailyAutonomyLiveApproved: process.env.TRUST402_DAILY_AUTONOMY_LIVE_APPROVED === "true",
  dailyAutonomyGoal: process.env.TRUST402_DAILY_AUTONOMY_GOAL || "Run daily buyer-side diligence on allowlisted x402 resources and produce receipts.",
  dailyAutonomyBudgetUsd: Number.parseFloat(process.env.TRUST402_DAILY_AUTONOMY_BUDGET_USD || "0.02"),
  dailyAutonomyMaxPaidCalls: Number.parseInt(process.env.TRUST402_DAILY_AUTONOMY_MAX_PAID_CALLS || "1", 10),
  dailyAutonomyIncludeProofPreview: process.env.TRUST402_DAILY_AUTONOMY_INCLUDE_PROOF_PREVIEW !== "false",
  ...
  discoveryRegistryFetchEnabled: process.env.TRUST402_DISCOVERY_REGISTRY_FETCH_ENABLED === "true",
  discoveryRegistryUrls: parseList(process.env.TRUST402_DISCOVERY_REGISTRY_URLS || ""),
  ...
  cdpBazaarExpectedResources: Number.parseInt(process.env.TRUST402_CDP_BAZAAR_EXPECTED_RESOURCES || "0", 10),
  cdpBazaarIndexedResources: Number.parseInt(process.env.TRUST402_CDP_BAZAAR_INDEXED_RESOURCES || "0", 10),
  cdpBazaarMissingResources: parseList(process.env.TRUST402_CDP_BAZAAR_MISSING_RESOURCES || ""),
